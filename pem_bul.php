...
<body>
            ...
            <div class="animated fadeIn">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="row">
    <div class="col-md-6"><strong class="card-title">PEMELIHARAAN BULANAN</strong></div>
  ...
  <?php
                                ...
                                $id_al = $_POST['id_al'];
                                $id_k = $_POST['id_k']; 
                                $nama_pem_bul = $_POST['nama_pem_bul'];
                               
                                 if(isset($_POST['tambah'])){

                                    $sqlx="SELECT *
                                        FROM pemeliharaan_bul
                                        ...
                                        if($fafac)
                                        {
                                            $nilaihasil = "Pemeliharaan Sudah Ada.";
                                              ...
                                              ///
                                              $nilaiuser = "User $username gagal menambah pemeliharaan bulanan";
                                              ...
                                              ///
                                                    ...
                                                    $sql_tambah = "INSERT INTO pemeliharaan_bul VALUES (NULL,'$id_al','$id_k','','1')";
                                                    if(mysqli_query($conn, $sql_tambah))
                                                    {
                                                        $nilaihasil = "Records updated successfully.";

                                                        ///
                                              $nilaiuser = "User $username sukses menambah pemeliharaan bulanan";
                                              $sql = "INSERT INTO log_user VALUES (NULL,'$id_login',now(), 'tambah-pemeliharaan','$nilaiuser')";
                                              mysqli_query($conn, $sql);
                                              ///
                                                    } 
                                 ...
                                 if($_POST['edit']){
                                    ...
                                    if($fafac)
                                    {
                                        $nilaihasil = "Pemeliharaan Sudah Ada.";
                                        ///
                                        $nilaiuser = "User $username gagal edit pemeliharaan bulanan";
                                        $sql = "INSERT INTO log_user VALUES (NULL,'$id_login',now(), 'edit-pemeliharaan','$nilaiuser')";
                                        mysqli_query($conn, $sql);
                                        ///
                                    }
                                    else{
                                    $sql_edit = "UPDATE pemeliharaan_bul SET id_al = '$id_al', id_k = '$id_k' , nama_pem_bul = '$nama_pem_bul' WHERE id_p_b = '$id_p_b'";
                                    if(mysqli_query($conn, $sql_edit))
                                    {
                                        $nilaihasil = "Records updated successfully.";
                                        ///
                                        $nilaiuser = "User $username sukses edit pemeliharaan bulanan";
                                        $sql = "INSERT INTO log_user VALUES (NULL,'$id_login',now(), 'edit-pemeliharaan','$nilaiuser')";
                                        mysqli_query($conn, $sql);
                                        ///
                                    } 
                                ...
                                if($_POST['editsemua']){
                                    ...
                                    $sql_edit = "UPDATE pemeliharaan_bul SET id_al = '$id_al', id_k = '$id_k' WHERE id_k = '$id_klam' AND id_al = '$id_allam'";
                                    if(mysqli_query($conn, $sql_edit))
                                    {
                                        $nilaihasil = "Records updated successfully.";
                                        ///
                                ...
                                if($_POST['hapussemua']){
                                    $id_allam= $_POST['id_allam'];
                                    $id_klam= $_POST['id_klam'];
                                    $queryhapus=mysqli_query($conn, "DELETE FROM pemeliharaan_bul WHERE id_al='$id_allam' AND id_k='$id_klam'");
                                    $nilaihasil = "Deleted Row.";
                                        ///
                                        $nilaiuser = "User $username menghapus pemeliharaan bulanan";
                            ...
                            ?>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sqlx="SELECT DISTINCT pemeliharaan_bul.id_al
                                        FROM pemeliharaan_bul, kegiatan, alat
                                        WHERE pemeliharaan_bul.id_k=kegiatan.id_k AND pemeliharaan_bul.id_al=alat.id_al";
                                        $resultx=mysqli_query($conn,$sqlx);
                                                   ...
                                                   $sql="SELECT *
                                                    FROM pemeliharaan_bul, kegiatan, alat
                                                    WHERE pemeliharaan_bul.id_k=kegiatan.id_k AND pemeliharaan_bul.id_al=alat.id_al AND pemeliharaan_bul.id_al = $id_alx GROUP BY pemeliharaan_bul.id_k";
                                                    $result=mysqli_query($conn,$sql);
                                                    $fafa = mysqli_num_rows($result);
                                                    // echo "$fafa";
                                    ...
                                    ?>
                                        ...
                                        {
                                            ?>
                                              <a href="tables-subkegb.php?id_po=<?php echo $row['id_p_b']?>&&id_alpo=<?php echo $row['id_al']?>&&id_kpo=<?php echo $row['id_k']?>&&nama_pempo=<?php echo $row['nama_pem_bul']?>&&nama_po=<?php echo $row['nama_keg']?>&&nama_alpo=<?php echo $row['nama_alat']?>" ><i class="fa fa-plus"></i> Add</a>
                                        ...
                                        {
                                            ?>
                                            <a href="tables-subkegb.php?id_po=<?php echo $row['id_p_b']?>&&id_alpo=<?php echo $row['id_al']?>&&id_kpo=<?php echo $row['id_k']?>&&nama_pempo=<?php echo $row['nama_pem_bul']?>&&nama_po=<?php echo $row['nama_keg']?>&&nama_alpo=<?php echo $row['nama_alat']?>" > View Komponen</a>
                                        ...
                                        {
                                            ?>
                                            <a href="#edit<?php echo $row['id_p_b']?>" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                             <a href="#hapussemua<?php echo $row['id_p_b']?>" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                                          <?php
                                        }
                                        else
                                        {
                                            ?>
                                            <a href="#editsemua<?php echo $row['id_p_b']?>" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                             <a href="#hapussemua<?php echo $row['id_p_b']?>" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                                             <?php
                                        }
                                        ?>
                                    ...
                                    <div id="edit<?php echo $row['id_p_b']?>" class="modal fade" role="dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="" method="post">
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="id_p_b" value="<?php echo $row['id_p_b']?>" class="form-control" id="id_k">
                        ...
                        <div id="editsemua<?php echo $row['id_p_b']?>" class="modal fade" role="dialog">
                                ...
                                <div id="hapussemua<?php echo $row['id_p_b']?>" class="modal fade" role="dialog">
                        ...
                        <div id="status<?php echo $row['id_p_b']?>" class="modal fade" role="dialog">        
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    ...
                                    <?php
                                    if($row['status_pem_bul'] == 0)
                                    {
                                    ?>
                                    <form action="" method="post">
                                    <div class="modal-body">
                                    Aktifkan <?php echo $row['nama_pem_bul']?> ?

                                    <div class="modal-footer">
                                    <input hidden type="text" name="id_p_b" value="<?php echo $row['id_p_b']?>" class="form-control" id="id_p_b">
                                    ...
                                    else
                                    {
                                        ...
                                        <form action="" method="post">
                                        <div class="modal-body">
                                    Disable <?php echo $row['nama_pem_bul']?> ?
