...
<body class="sb-nav-fixed">
            ...
            <div class="animated fadeIn">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="row">
    <div class="col-md-6"><strong class="card-title">PEMELIHARAAN MINGGUAN</strong></div>
  ...
  <?php
                                ...
                                $id_al = $_POST['id_al'];
                                $id_k = $_POST['id_k']; 
                                $nama_pem_ming = $_POST['nama_pem_ming'];
                               
                                 if(isset($_POST['tambah'])){

                                    $sqlx="SELECT *
                                        FROM pemeliharaan_ming
                                        ...
                                        if($fafac)
                                        {
                                            $nilaihasil = "Pemeliharaan Sudah Ada.";
                                              ...
                                              ///
                                              $nilaiuser = "User $username gagal menambah pemeliharaan mingguan";
                                              ...
                                              ///
                                                    ...
                                                    $sql_tambah = "INSERT INTO pemeliharaan_ming VALUES (NULL,'$id_al','$id_k','','1')";
                                                    if(mysqli_query($conn, $sql_tambah))
                                                    {
                                                        $nilaihasil = "Records updated successfully.";

                                                        ///
                                              $nilaiuser = "User $username sukses menambah pemeliharaan mingguan";
                                              $sql = "INSERT INTO log_user VALUES (NULL,'$id_login',now(), 'tambah-pemeliharaan','$nilaiuser')";
                                              mysqli_query($conn, $sql);
                                              ///
                                                    } 
                                 ...
                                 if($_POST['edit']){
                                    ...
                                    if($fafac)
                                    {
                                        $nilaihasil = "Pemeliharaan Sudah Ada.";
                                        ///
                                        $nilaiuser = "User $username gagal edit pemeliharaan mingguan";
                                        $sql = "INSERT INTO log_user VALUES (NULL,'$id_login',now(), 'edit-pemeliharaan','$nilaiuser')";
                                        mysqli_query($conn, $sql);
                                        ///
                                    }
                                    else{
                                    $sql_edit = "UPDATE pemeliharaan_ming SET id_al = '$id_al', id_k = '$id_k' , nama_pem_ming = '$nama_pem_ming' WHERE id_p_m = '$id_p_m'";
                                    if(mysqli_query($conn, $sql_edit))
                                    {
                                        $nilaihasil = "Records updated successfully.";
                                        ///
                                        $nilaiuser = "User $username sukses edit pemeliharaan mingguan";
                                        $sql = "INSERT INTO log_user VALUES (NULL,'$id_login',now(), 'edit-pemeliharaan','$nilaiuser')";
                                        mysqli_query($conn, $sql);
                                        ///
                                    } 
                                ...
                                if($_POST['editsemua']){
                                    ...
                                    $sql_edit = "UPDATE pemeliharaan_ming SET id_al = '$id_al', id_k = '$id_k' WHERE id_k = '$id_klam' AND id_al = '$id_allam'";
                                    if(mysqli_query($conn, $sql_edit))
                                    {
                                        $nilaihasil = "Records updated successfully.";
                                        ///
                                ...
                                if($_POST['hapussemua']){
                                    $id_allam= $_POST['id_allam'];
                                    $id_klam= $_POST['id_klam'];
                                    $queryhapus=mysqli_query($conn, "DELETE FROM pemeliharaan_ming WHERE id_al='$id_allam' AND id_k='$id_klam'");
                                    $nilaihasil = "Deleted Row.";
                                        ///
                                        $nilaiuser = "User $username menghapus pemeliharaan mingguan";
...
<table id="tabel-data" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                       ...
                                       $sqlx="SELECT DISTINCT pemeliharaan_ming.id_al
                                       FROM pemeliharaan_ming, kegiatan, alat
                                       WHERE pemeliharaan_ming.id_k=kegiatan.id_k AND pemeliharaan_ming.id_al=alat.id_al";
                                       $resultx=mysqli_query($conn,$sqlx);
                                                  ...
                                                  $sql="SELECT *
                                                   FROM pemeliharaan_ming, kegiatan, alat
                                                   WHERE pemeliharaan_ming.id_k=kegiatan.id_k AND pemeliharaan_ming.id_al=alat.id_al AND pemeliharaan_ming.id_al = $id_alx GROUP BY pemeliharaan_ming.id_k";
                                    ...
                                    ?>
                                        ...
                                        {
                                            ?>
                                              <a href="tables-subkegm.php?id_po=<?php echo $row['id_p_m']?>&&id_alpo=<?php echo $row['id_al']?>&&id_kpo=<?php echo $row['id_k']?>&&nama_pempo=<?php echo $row['nama_pem_ming']?>&&nama_po=<?php echo $row['nama_keg']?>&&nama_alpo=<?php echo $row['nama_alat']?>" ><i class="fa fa-plus"></i> Add</a>
                                        ...
                                        {
                                            ?>
                                            <a href="tables-subkegm.php?id_po=<?php echo $row['id_p_m']?>&&id_alpo=<?php echo $row['id_al']?>&&id_kpo=<?php echo $row['id_k']?>&&nama_pempo=<?php echo $row['nama_pem_ming']?>&&nama_po=<?php echo $row['nama_keg']?>&&nama_alpo=<?php echo $row['nama_alat']?>" > View Komponen</a>
                                        ...
                                        {
                                            ?>
                                             <a href="#edit<?php echo $row['id_p_m']?>" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                             <a href="#hapussemua<?php echo $row['id_p_m']?>" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                                          <?php
                                        }
                                        else
                                        {
                                            ?>
                                           <a href="#editsemua<?php echo $row['id_p_m']?>" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                           <a href="#hapussemua<?php echo $row['id_p_m']?>" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                                    ...
                                    <div id="edit<?php echo $row['id_p_m']?>" class="modal fade" role="dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="" method="post">
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="id_p_m" value="<?php echo $row['id_p_m']?>" class="form-control" id="id_k">
                        ...
                        <div id="editsemua<?php echo $row['id_p_m']?>" class="modal fade" role="dialog">
                        ...
                        <div id="hapussemua<?php echo $row['id_p_m']?>" class="modal fade" role="dialog">
                        ...
                        <div id="status<?php echo $row['id_p_m']?>" class="modal fade" role="dialog">        
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    ...
                                    <?php
                                    if($row['status_pem_ming'] == 0)
                                    {
                                    ?>
                                    <form action="" method="post">
                                    <div class="modal-body">
                                    Aktifkan <?php echo $row['nama_pem_ming']?> ?

                                    <div class="modal-footer">
                                    <input hidden type="text" name="id_p_m" value="<?php echo $row['id_p_m']?>" class="form-control" id="id_p_m">
                                    ...
                                    else
                                    {
                                        ...
                                        <form action="" method="post">
                                        <div class="modal-body">
                                    Disable <?php echo $row['nama_pem_ming']?> ?
