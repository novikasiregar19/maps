...
$nilaiuser = "User $username input checklist pemeliharaan $nama_alat;$nama_merk";
                                                  ...
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          <div class="modal-header">
                                                              ...
                                                              <h4 class="modal-title">Keterangan Kerusakan</h4>
                                                          </div>
                                                          <form action="" method="post">
                                                              <div class="modal-body">
                                                                  ...
                                                                  <input type="hidden" name="id_totc" value="<?php echo $row['id_tot']?>" class="form-control" id="id_tot">
